...
#Are there certain words that feature more often in Movie Titles?
...
# Calling this function gives access to a list of genre keywords
# which are sorted by decreasing frequency
...
print (genre_recommendations('Toy Story (1995)').head(10))
print(genre_recommendations('Saving Private Ryan (1998)').head(10))
print (genre_recommendations('Good Will Hunting (1997)').head(10))
